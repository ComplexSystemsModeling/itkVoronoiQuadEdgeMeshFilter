...
\begin{figure}
\center
\subfloat[]{\label{fig:straightwalka}\includegraphics[width=0.4\textwidth]{Algorithm_description}} \hspace{10pt}
\subfloat[]{\label{fig:straightwalkb}\includegraphics[width=0.4\textwidth]{Algorithm_predicate}}
