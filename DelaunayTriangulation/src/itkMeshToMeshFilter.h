...
class ITK_EXPORT MeshToMeshFilter:public PointSetToMeshFilter< TInputMesh, TOutputMesh >
{
public:
  /** Standard class typedefs. */
  typedef MeshToMeshFilter                                 Self;
  typedef PointSetToMeshFilter< TInputMesh, TOutputMesh >  Superclass;
  ...
  itkTypeMacro(MeshToMeshFilter, PointSetToMeshFilter);
