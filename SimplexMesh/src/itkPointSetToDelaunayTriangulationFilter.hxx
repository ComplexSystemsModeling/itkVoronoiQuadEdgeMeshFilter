...
{ 
  ...
  std::cout << "Triangulation: we get the 1 triangle to check"<< std::endl;
  ...
  std::cout << "Triangulation: we test if border"<< std::endl;
  ...
  std::cout << "Triangulation: we get the 2 triangle to check"<< std::endl;
  ...
  std::cout << "Triangulation: we test if flip"<< std::endl;
  ...
  if( TestPointInTriangleInMesh< MeshType >( mesh, adjCell.first, pointCoord, true ) ) 
    {
      ...
      std::cout << "Triangulation: we flip"<< std::endl;
    ...
    e = flipedge->Evaluate( mesh->FindEdge( p[(r+1)%3], p[(r+2)%3] ) );
      ...
      std::cout << "Triangulation: we check the triangle"<< std::endl;
