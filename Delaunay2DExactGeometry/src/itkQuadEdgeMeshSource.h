...
namespace itk
{
/** \class QuadEdgeMeshSource
 *  \brief Base class for all process objects that output QuadEdgeMesh data.
 *
 * QuadEdgeMeshSource is the base class for all process objects that output
 * QuadEdgeMesh data. Specifically, this class defines the GetOutput() method
 * that returns a pointer to the output QuadEdgeMesh. The class also defines
...
class ITK_EXPORT QuadEdgeMeshSource : public ProcessObject
{
...
public:
  ...
  typedef TOutputQuadEdgeMesh                      OutputQuadEdgeMeshType;
  typedef typename OutputQuadEdgeMeshType::Pointer OutputQuadEdgeMeshPointer;

  typedef Superclass::DataObjectIdentifierType DataObjectIdentifierType;

  /** Get the QuadEdgeMesh output of this process object.  */
  OutputQuadEdgeMeshType * GetOutput( void );

  OutputQuadEdgeMeshType * GetOutput( unsigned int idx );

  /** Set the QuadEdgeMesh output of this process object. This call is slated
  ...
  void SetOutput( TOutputQuadEdgeMesh *output );
   ...
   * SmartPointer to a DataObject. If a subclass of QuadEdgeMeshSource has
...
protected:
  ...
  /** Requested region of QuadEdgeMesh is specified as i of N unstructured regions.
